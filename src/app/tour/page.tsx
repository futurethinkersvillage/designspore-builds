...
/**
 * /tour — full-screen interactive development map (formerly /map; middleware
 * 308-redirects /map here for old links).
 *
 ...
 * Next.js/React render tree. The middleware tags /tour as a full-screen route so
