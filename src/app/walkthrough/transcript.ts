...
export const transcript: TranscriptSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      { text: "Second, we need investment. We need to raise two stages: $6 million first in the next couple of months, to build the early stages of the maker space, do the feasibility study, get approvals, secure the land. That will leverage us into the next phase, which is $20 million and up. This is to build the larger vision of the property and the smart village. We're going to build the cabins and tiny homes, work on longer-term stays, add 50-amp services for the big park-model RVs and tiny homes. And then potentially, because land is so much cheaper in the south, we might even get the second property with that second phase of investment." },
  ...
  },
  {
    ...
    paragraphs: [
      ...
      { text: "We're entering phase two of the next round of fundraising. We're looking to raise $6 million through a combination of donation and investment, and we're moving into phase three after that, which is building out the larger vision of the project and expanding the network." },
